                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=1">
                                <img src="${pageContext.request.contextPath}/resources/img/반도.jpg" alt="사진 1" style="width:30%;">
                            </a>
                     &nbsp;&nbsp;
                     &nbsp;&nbsp;
                     &nbsp;&nbsp;
                     &nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=4">
                                <img src="${pageContext.request.contextPath}/resources/img/살아있다.jpg" alt="사진 2" style="width:30%;">
                            </a>
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=2">
                                <img src="${pageContext.request.contextPath}/resources/img/온워드.jpg" alt="사진 3" style="width:30%;">
                            </a>
                        </div>

                        <div class="item">
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=5">
                                <img src="${pageContext.request.contextPath}/resources/img/밤쉘.jpg" alt="사진 4" style="width:30%;">
                            </a>
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=7">
                                <img src="${pageContext.request.contextPath}/resources/img/소년시절.jpg" alt="사진 5" style="width:30%;">
                            </a>
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=3">
                                <img src="${pageContext.request.contextPath}/resources/img/알라딘.jpg" alt="사진 6" style="width:30%;">
                            </a>
                        </div>

                        <div class="item">
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=8" >
                                <img src="${pageContext.request.contextPath}/resources/img/팬데믹.jpg" alt="사진 7" style="width:30%;">
                            </a>
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=6">
                                <img src="${pageContext.request.contextPath}/resources/img/블루아워.jpg" alt="사진 8" style="width:30%;">
                            </a>
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            &nbsp;&nbsp;
                            <a href="${pageContext.request.contextPath}/movie/movieDetail?mno=9">
                                <img src="${pageContext.request.contextPath}/resources/img/아디오스.jpg" alt="사진 9" style="width:30%;">
                            </a>
                        </div>
                    </div>
                  ...
                  <article class="help_box1">
                      ...
                      <div class="notice">
                                  ...
                                  <ul style="display: block;">
                                      ...
                                      <li class="active">
                                          <dl>
                                              <dt><em><fmt:formatDate value="${vo.regdate }" pattern="yyyy-MM-dd hh:mm:ss"/> </em></dt>
                                              <dd><a style="width: auto;" href="${pageContext.request.contextPath }/board/noticeDetail?tno=${vo.tno}&MEMBERS_ID=${sessionScope.MEMBERS_ID}">${vo.title}</a></dd>
                                          </dl>            
                                      </li>
                                      </c:forEach>
                                  </ul>
                                  <br>
                                  <div class= "allnotice">
                                       <a  href="${pageContext.request.contextPath}/board/notice">전체 공지 보러가기</a>
                                   </div>
                      </div>
                  </article>
                  <article class="help_box2">
                      ...
                      <div class="card">
                          <ul>
                              <li>
                                  <a href="#">
                                      <span><img src="${pageContext.request.contextPath}/resources/assets/img/card01.jpg" srcset="assets/img/card01@2.jpg 2x" alt="card01"></span>
                              ...
                              <li>
                                  <a href="#">
                                      <span><img src="${pageContext.request.contextPath}/resources/assets/img/card02.jpg" srcset="assets/img/card02@2.jpg 2x" alt="card02"></span>
                                      <strong>LG U+</strong>
                                      <em>영화 2,000원 현장 즉시 할인(1일 5매)</em>
                                  </a>
                              </li>
                              <li>
                                  <a href="#">
                                      <span><img src="${pageContext.request.contextPath}/resources/assets/img/card03.jpg" srcset="assets/img/card03@2.jpg 2x" alt="card03 "></span>
                  ...
                  <article class="help_box3">
                      ...
                      <div class="service">
                          <ul>
                              ...
                              <li>
                                  <a href="${pageContext.request.contextPath}/missboard/MissingList">
                                      <span class="img_svg">
                                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120 120" style="enable-background:new 0 0 120 120;" xml:space="preserve">
                                              <style type="text/css">
                                                  .st0{fill:none;}
